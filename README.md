...
[![Container Repository on Quay](https://quay.io/repository/samdoran/fedora33-ansible/status "Container Repository on Quay")](https://quay.io/repository/samdoran/fedora31-ansible)
...
To build your own version of this container, run:
    ...
    podman build -t fedora33-ansible -f Containerfile .
...
platforms:
  - name: role-test
    image: "quay.io/samdoran/${MOLECULE_DISTRIBUTION:-fedora33}-ansible:latest"
